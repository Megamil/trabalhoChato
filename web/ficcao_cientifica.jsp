...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	...
	<div class="row text-center">
		<div id="Menu" class="col-sm-12">
			<div class="btn-group" role="group" aria-label="...">
				...
				<button type="button" class="btn btn-default active"><a href="ficcao_cientifica.jsp">Ficção Ciêntífica</a></button>
	...
	<div id="Livros" class="row">
		...
		<%
                    ...
                    ResultSet livros = dao.localizarLivros(6);
                            ...
                            out.print("<div class='livro-item col-sm-12 margin-top10'>");
                                ...
                                out.print("<div class='col-sm-8 padding0'>");
                                    ...
                                    out.print("<div class='form-group clearfix'>");
                                        ...
                                        out.print("</div>");
                                        out.print("<div class='col-sm-8'>");
                                            out.print("<input type='hidden' name='categoria' value ='6'>" + "Ficção Científica");
                                        out.print("</div>");
                                    out.print("</div>");
                                    out.print("<div class='form-group clearfix'>");
                                        out.print("<div class='col-sm-2 text-right'>");
